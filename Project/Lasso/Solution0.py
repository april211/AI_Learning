...
import Lasso_MBGD_SubGD as lms
import matplotlib.pyplot as plt

""" 结合 小批量随机梯度下降 & 次梯度的Lasso回归 """
...
model = lms.Lasso(Lambda=0.01)                  # 0.001 -> 0.01 -> 0.1 -> 0.5
loss = model.fit(X_poly, y, eta_0=10, eta_1=50, N=3000, B=10)
...
# 做出拟合曲线图
axs[0].set_title("MBGD & SubGD Fitted Curve")
...
axs[1].plot(tepoch[:200], loss[:200])           # 节选了 [:200]这部分进行绘制，更容易看出前期的变化
