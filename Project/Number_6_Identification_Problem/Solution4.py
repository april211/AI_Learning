...
import Logistic_Regression_GD as lrgd
...
model = lrgd.LogisticRegressionGD()
model.fit(X_train, y_train, eta=0.1, N=9000)
...
model.fit(X_train, y_train, eta=0.1, N=20)
proba = model.predict_proba(X_test)
y_pred = model.predict(X_test)
plt.figure(2)
...
model.fit(X_train, y_train, eta=0.1, N=100)
proba = model.predict_proba(X_test)
y_pred = model.predict(X_test)
plt.figure(3)
fpr, tpr = roc.plot_roc_curve(proba, y_test)
...
model.fit(X_train, y_train, eta=0.1, N=200)
proba = model.predict_proba(X_test)
y_pred = model.predict(X_test)
plt.figure(4)
fpr, tpr = roc.plot_roc_curve(proba, y_test)
